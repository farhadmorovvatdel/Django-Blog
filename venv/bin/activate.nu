...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/farhadmorovvatdel/Desktop/DjangoBlog/venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/farhadmorovvatdel/Desktop/DjangoBlog/venv/bin/deactivate.nu'
